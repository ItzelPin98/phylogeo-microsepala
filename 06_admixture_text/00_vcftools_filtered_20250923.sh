...
vcftools \
 ...
 # A continuación, los SNPs fueron filtrados empleando los siguientes parámetros: profundidad media mínima de lectura de 21X, frecuencia alélica mínima (MAF) de 0,02 
 # y un umbral máximo de datos faltantes del 30 % por sitio. Posteriormente, se calculó el porcentaje de datos 
 # faltantes por individuo, eliminándose aquellas muestras que presentaron más del 10 % de genotipos ausentes.
 
 ## LEER BIEN LOS PARAMETROS Y QUE SIGNIFICAN ##
